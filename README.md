...
本项目仅供学习、研究和个人自动化使用，与红魔、努比亚及其关联方无官方关系。使用者应仅操作本人有权使用的账号，并自行确认相关行为符合所在地法律法规及红魔社区规则。

请勿将本项目用于批量滥用、攻击接口、绕过平台限制或其他违规用途。社区接口、活动规则和账号策略可能随时调整，因使用或修改本项目造成的账号限制、奖励异常、数据损失或其他后果，由使用者自行承担。

在地球及已知宇宙范围内，请尊重服务资源、保护个人凭证，并对自己的每一次运行负责。
